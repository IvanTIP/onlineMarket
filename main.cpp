...
public:
    void fillData () {
        std::string article;
        int count;
        std::cout << "Fill the store with the product" << std::endl;
        while (true) {
            std::cout << "Enter article or \"exit\" to exit: ";
            std::cin >> article;
            if (article == "exit") {
                break;
            }
    ...
    void shopping () {
        ...
        while (true) {
            ...
            std::cout << "Choose command \"add\" to or \"remove\" from basket: ";
            std::cin >> command;
            try {
            ...
            if (command == "add") {
                try {
                    ...
                    std::cerr << "Missing article: " << x.what() << std::endl;
                    continue;
                }
                try {
                    if (it->second < count) {
